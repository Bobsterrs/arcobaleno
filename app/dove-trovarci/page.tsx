...
import { MapPin, Clock, Phone, ArrowRight, ExternalLink, Star } from 'lucide-react'
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.arcobalenosenzaglutine.it/dove-trovarci',
  },
}
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-lg mb-1">Puoi trovarci su Google</h4>
                  <p className="text-gray-600 font-light mb-2">Siamo valutati 5.0 stelle dalla nostra community.</p>
                  <a 
                    href="https://www.google.com/search?q=Arcobaleno+Senza+Glutine+Casalfiumanese" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-emerald-600 font-medium hover:underline flex items-center gap-1"
                  >
                    Vedi profilo attività
              ...
              <div className="mt-10">
                <Link 
                  href="https://www.google.com/maps/search/?api=1&query=Arcobaleno+Senza+Glutine+Via+Montanara+13g+Casalfiumanese"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto"
                >
                  <Button variant="primary" className="w-full sm:w-auto py-6 rounded-full">
